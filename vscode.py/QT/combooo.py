...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.submet = QtWidgets.QPushButton(self.centralwidget)
        self.submet.setGeometry(QtCore.QRect(190, 330, 211, 71))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.submet.setFont(font)
        self.submet.setObjectName("submet")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.submet.setText(_translate("MainWindow", "submet"))
